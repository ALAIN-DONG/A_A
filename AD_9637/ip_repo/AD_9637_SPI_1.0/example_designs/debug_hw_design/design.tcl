...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of AD_9637_SPI_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AD_9637_SPI_0/AD_9637_SPI]
	connect_bd_net [get_bd_pins AD_9637_SPI_0/ad_9637_spi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AD_9637_SPI_0/ad_9637_spi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to AD_9637_SPI_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AD_9637_SPI_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AD_9637_SPI_0_AD_9637_SPI_* ]]
	puts $fp "set ad_9637_spi_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AD_9637_SPI_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AD_9637_SPI_v1_0_hw_${i}"
